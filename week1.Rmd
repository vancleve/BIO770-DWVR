...
RStudio is an Integrated Development Environment (IDE) for the R programming language. While you can write R code in any text editor you like and then run that code with the R interpreter, there are many things that an IDE can do that help you be more efficient when programming.
...
#### Write a few sentences about what kind of data you are thinking of analyzing and visualizing

+ Create your own R Markdown document.
+ Use some Markdown elements to structure your document.
